...
def detection(typ, p, best, long_ft, short_ft, *, bd=0, kind="building_focus",
              seam=False, rescue=False, review=False):
    return {
        "type": typ, "p": p, "best_class_prob": best, "long_ft": long_ft,
        "short_ft": short_ft, "building_distance_ft": bd, "view_kind": kind,
        "internal_tile_edge": seam, "rescue": rescue, "review_only": review,
        "attribution_scope": "PARCEL", "candidate": 0.5,
    }
...
class V0115LogicTests(unittest.TestCase):
    def test_frozen_primary_operating_points(self):
        self.assertEqual(app.APP_VERSION,"0.11.5")
